...
object WaveOverlay {
    ...
    private val fogIcons = mapOf(
        "blue" to "wave_fog_blue",
        "yellow" to "wave_fog_yellow",
        "red" to "wave_fog_red"
    )
    ...
    fun addOrUpdate(context: Context, style: Style, points: List<GribPoint>) {
        ...
        points.forEach { point ->
            ...
            val fog = WaveOverlayUtil.getFogImageName(value.toDouble())
                ...
                SymbolLayer(TEXT_LAYER_ID, SOURCE_ID)
                    .withProperties(
                        textField(org.maplibre.android.style.expressions.Expression.concat(
                            ...
                            org.maplibre.android.style.expressions.Expression.literal(" m")
                        )),
